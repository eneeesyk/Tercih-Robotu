...
function changeImageAndAddList(id) {
    if (document.getElementById(id).firstChild.getAttribute('src') == "images/circle-plus-solid.svg") 
    {
        ...
        alertify.success('Tercih Listesine Eklendi');
    }
    else 
    {
...
*/
 ...
 function clearSelected(){
    var elements = document.getElementsByClassName("selectpicker").options;
    for(var i = 0; i < elements.length; i++){
        var element = elements[i].options;
